...
@section('content')
    ...
    <div class="card-body">
        <div class="contabit-model-actions my-4" >
            <a href="{{url('terceros/create')}}" class="btn btn-primary btn-sm" >
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <action-btns
                                el_id="{{$tercero->id}}"
                                resources_url="{{url('terceros')}}"
                            >@csrf</action-btns>
                        </td>
                        <td class="text-left">{{$tercero->nombres}} {{$tercero->apellidos}}</td>
                        <td>{{$tercero->tipo_de_documento}} {{$tercero->nid}}</td>
                        <td>{{$tercero->telefono}} <br> {{$tercero->correo}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
